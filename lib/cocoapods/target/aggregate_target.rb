...
module Pod
  ...
  class AggregateTarget < Target
    ...
    # @param  [String] configuration the configuration this path is for.
    #
    # @return [Pathname] The absolute path of the embed xcframeworks script input file list.
    #
    def embed_xcframeworks_script_input_files_path(configuration)
      support_files_dir + "#{label}-xcframeworks-#{configuration}-input-files.xcfilelist"
    end

    # @param  [String] configuration the configuration this path is for.
    #
    # @return [Pathname] The absolute path of the embed xcframeworks script output file list.
    #
    def embed_xcframeworks_script_output_files_path(configuration)
      support_files_dir + "#{label}-xcframeworks-#{configuration}-output-files.xcfilelist"
    end
    ...
    # @return [String] The path of the embed xcframeworks relative to the
    #         root of the Pods project.
    #
    def embed_xcframeworks_script_relative_path
      "${PODS_ROOT}/#{relative_to_pods_root(embed_xcframeworks_script_path)}"
    end

    # @return [String] The path of the embed xcframeworks script input file list
    #         relative to the root of the Pods project.
    #
    def embed_xcframeworks_script_input_files_relative_path
      "${PODS_ROOT}/#{relative_to_pods_root(embed_xcframeworks_script_input_files_path('${CONFIGURATION}'))}"
    end

    # @return [String] The path of the embed xcframeworks script output file list
    #         relative to the root of the Pods project.
    #
    def embed_xcframeworks_script_output_files_relative_path
      "${PODS_ROOT}/#{relative_to_pods_root(embed_xcframeworks_script_output_files_path('${CONFIGURATION}'))}"
    end
